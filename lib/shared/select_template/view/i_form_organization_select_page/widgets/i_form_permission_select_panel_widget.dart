...
import 'package:app/shared/select_template/view/i_form_permission_select_page/widgets/i_form_permission_select_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        ...permissionsList.map(
          (permission) {
            return IFormPermissionSelectView(
